# 📸 Universal Video Frame Grabber

A powerful, lightweight Chrome Extension (Manifest V3) that lets you extract high-quality, clutter-free frames from videos on **any website** (YouTube, Instagram, Facebook, Reddit, Twitter/X, and more).
...
1.  **Clone or Download** this repository.
    ```bash
    git clone [https://github.com/tanvir63566/universal-video-frame-grabber.git](https://github.com/tanvir63566/universal-video-frame-grabber.git)
    ```
